...
namespace Mnemo.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251216045735_AddSubmissionGroups")]
    partial class AddSubmissionGroups
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mnemo.Domain.Entities.Document", b =>
                {
                    ...
                    b.HasIndex("SubmissionGroupId")
                        .HasDatabaseName("i_x_documents_submission_group_id")
            ...
            modelBuilder.Entity("Mnemo.Domain.Entities.Policy", b =>
                {
                    ...
                    b.HasIndex("SubmissionGroupId")
                        .HasDatabaseName("i_x_policies_submission_group_id")
                        .HasFilter("submission_group_id IS NOT NULL");
            ...
            modelBuilder.Entity("Mnemo.Domain.Entities.SubmissionGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_submission_groups");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("i_x_submission_groups_tenant_id");

                    b.HasIndex("TenantId", "InsuredName");

                    b.ToTable("submission_groups");
                });
            ...
            modelBuilder.Entity("Mnemo.Domain.Entities.Document", b =>
                {
                    b.HasOne("Mnemo.Domain.Entities.SubmissionGroup", "SubmissionGroup")
                        .WithMany("Documents")
                        .HasForeignKey("SubmissionGroupId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("f_k_documents__submission_groups_submission_group_id");
            ...
            modelBuilder.Entity("Mnemo.Domain.Entities.Policy", b =>
                {
                    ...
                    b.HasOne("Mnemo.Domain.Entities.SubmissionGroup", "SubmissionGroup")
                        ...
                        .HasForeignKey("SubmissionGroupId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("f_k_policies__submission_groups_submission_group_id");
            ...
            modelBuilder.Entity("Mnemo.Domain.Entities.SubmissionGroup", b =>
                {
                    b.HasOne("Mnemo.Domain.Entities.Tenant", "Tenant")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_submission_groups__tenants_tenant_id");
